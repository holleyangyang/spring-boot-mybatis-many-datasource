...
method.setEntity(new StringEntity(jsonParam.toString(), Charset.forName("UTF-8")));
	...
	public static void main(String[] args) {
		String url ="https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=wxfd3c98939b419c4c&corpsecret=scBnjpSgH--DCYI-f-pOvjy2eqGIPC_qCmf_K4LRi-g";
		String token = doPost(url);
